...
class Pantalla(QtWidgets.QMainWindow, form_class):
    ...
    btnmulti = QtCore.Signal()
    btndivi = QtCore.Signal()
    btnsalir = QtCore.Signal()
...
if __name__ == "__main__":
    import sys
    #from ..feature_presenter.Presenter import Presenter <- AQUI
    ...
    #presentador = Presenter(pantalla, modelo) <- AQUI
